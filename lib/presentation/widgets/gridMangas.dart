...
import 'package:zero_manga_plus_view/presentation/views/detail_manga.dart';
  ...
  return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return GestureDetector(
          onTap: () async {
            await Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => DetailManga(mangaUrl: manga.mangaUrl!)));
          },
          child: Container(
